...
export const pt141: Peptide = {
  ...
  eli5: 'The only FDA-approved peptide for low sexual desire in women (brand name Vyleesi). Unlike Viagra which works on blood flow, this one works in your brain — it activates receptors that control arousal and desire. It was actually discovered by accident when a tanning peptide kept causing erections in test subjects.',
