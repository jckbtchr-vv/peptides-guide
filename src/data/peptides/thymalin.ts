...
export const thymalin: Peptide = {
  ...
  eli5: 'An extract from cow thymus glands used in Russia to restore immune function. Part of the same anti-aging research program as Epitalon — one targets your pineal gland, the other targets your thymus. Together they address two key organs that deteriorate with age.',
