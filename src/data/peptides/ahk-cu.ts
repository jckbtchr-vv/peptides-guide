...
export const ahkCu: Peptide = {
  ...
  eli5: 'A copper peptide cousin of GHK-Cu that seems to be better specifically at waking up hair follicles. It feeds copper to the cells at the base of your hair follicles, supporting the enzymes they need to grow. Used in scalp serums, usually combined with minoxidil.',
