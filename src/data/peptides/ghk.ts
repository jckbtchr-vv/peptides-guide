...
export const ghk: Peptide = {
  ...
  eli5: 'The peptide backbone of GHK-Cu, without the copper attached. Still biologically active — it signals cells to repair and remodel tissue. Used in skincare when copper would clash with other ingredients like vitamin C. Think of it as the messenger without the delivery truck.',
