...
export const fiveAmino1mq: Peptide = {
  ...
  eli5: 'Not a peptide — it\'s a small molecule that blocks an enzyme (NNMT) overactive in fat cells. When you block this enzyme, fat cells shift from storing energy to burning it. In mice, it reduced body fat without changing appetite. No human trials yet.',
