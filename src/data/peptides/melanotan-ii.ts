...
export const melanotanII: Peptide = {
  ...
  eli5: 'A peptide that activates your tanning response without needing UV light. Inject it and your skin darkens over days. The catch: it also affects sexual arousal (which led to PT-141 being developed), appetite, and has real concerns about changing moles and potentially masking melanoma.',
