...
export const snap8: Peptide = {
  ...
  eli5: 'Argireline\'s bigger sibling — 8 amino acids instead of 6, designed to be better at blocking the nerve signals that cause expression wrinkles. The manufacturer says it works 30% better than Argireline, but there aren\'t independent studies to confirm that yet.',
