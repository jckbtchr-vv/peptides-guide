...
export const epitalon: Peptide = {
  ...
  eli5: 'A four-amino-acid peptide from Russian anti-aging research that reportedly reactivates telomerase — the enzyme that maintains the \'caps\' on your chromosomes that shorten with each cell division. Animal studies show lifespan extension, but nearly all the research comes from one lab in Russia.',
