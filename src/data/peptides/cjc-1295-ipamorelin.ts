...
export const cjc1295Ipamorelin: Peptide = {
  ...
  tldr: 'The most widely used GH secretagogue combination. GHRH analog + ghrelin mimetic produces 3-5x greater GH release than either alone through complementary pituitary signaling pathways.',

  eli5: 'The most popular \'GH stack.\' One peptide (CJC-1295) amplifies the growth hormone signal, the other (Ipamorelin) initiates it. Together they produce 3-5x more growth hormone than either alone — like pressing the gas pedal while also removing the brakes.',
