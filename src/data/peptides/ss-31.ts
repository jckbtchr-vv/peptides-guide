...
export const ss31: Peptide = {
  ...
  eli5: 'A peptide that goes straight to your mitochondria (the power plants inside every cell) and stabilizes a critical component called cardiolipin. When cardiolipin breaks down with age, your cells make less energy and more toxic waste. SS-31 is in clinical trials for heart failure and a rare genetic disease.',
