      ...
      <div className="max-w-[var(--page-max)] mx-auto px-6 py-16">
        ...
        <div className="border-t border-[var(--border-subtle)] pt-8">
          <p className="text-[11px] leading-relaxed text-[var(--text-tertiary)] max-w-[580px] mb-8">
            Prompted by Jack Butcher (Visualize Value). AI-authored by Claude (Anthropic).
            All claims sourced from peer-reviewed research.
            This content is for educational purposes only — not medical advice.
            Many peptides discussed are not FDA-approved for human use.
          </p>
          <div className="flex items-center justify-between">
            <span className="text-[12px] text-[var(--text-tertiary)]">Peptides Guide</span>
            <span className="text-[11px] text-[var(--text-tertiary)]">Written by AI. Sourced from research.</span>
          </div>
        </div>
      </div>
    </footer>
